...
**[Portfolio]** is a second project in Microverse in which we have a chance to work with Mobile Version.
...
```sh
  ...
  git clone git@github.com:Harris434/Portfolio-Project.git
```
...
Feel free to check the [https://github.com/Harris434/Portfolio-Project/issues](../../issues/).
